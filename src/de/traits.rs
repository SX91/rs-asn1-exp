...
pub trait Deserialize<'de>: Sized {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Err> where D: Deserializer<'de>;
    fn _deserialize_with_tag<D>(deserializer: D, expected_tag: &Tag) -> Result<Self, D::Err>
...
pub trait Deserializer<'de> {
    ...
    fn deserialize_bytes(self, expected_tag: &Tag) -> Result<&'de [u8], Self::Err>;
